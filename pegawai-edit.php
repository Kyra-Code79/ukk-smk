                ...
                <form action="pegawai-update.php" method="post" enctype="multipart/form-data">
                    ...
                    <div class="input-group input-group-sm mb-1">
                        ...
                        <input type="text" name="nama_pegawai" required autocomplete="off" class="form-control"
                            placeholder="Input Nama Pegawai" value="<?= $data['nama_pegawai']; ?>">
                    </div>
                    ...
                    <div class="input-group input-group-sm mb-1">
                        ...
                        <input type="text" id="telp" name="telp" required autocomplete="off" class="form-control"
                            placeholder="Input No Telp / HP" value="<?= $data['telp']; ?>">
                    </div>
                    <div class="input-group mb-1">
                    ...
                    <div class="input-group mb-1 input-sm">
                        <button type="submit" class="btn btn-sm btn-success"><i class="fas fa-save"></i> Update
                        </button>| <a href="pegawai.php" class="btn btn-sm btn-warning"><i class="fas fa-redo"></i>
                            Cancel</a>
                    </div>
                    </table>
                </form>
