            ...
            if($jabatan!="Kasir"){?>
                ...
                while ($k = mysqli_fetch_array($query)) {
                  ...
                  $nama_pegawai  = $k['nama_pegawai'];?>
                        ...
                        <button class="btn btn-sm btn-success text-white" type="submit" id="periodePrint"
                            name="cetak"><i class="fas fa-print"></i></button>
                </form>
            </div>
            <hr>
              ...
              ?>
                        ...
                        while ($data1 = mysqli_fetch_array($query1)) { ?>
                                        <tr>
                                            ...
                                            <?php
                            if ($jabatan == "Manajer") { ?>
                                            <td align="center"><i class="fas fa-trash text-danger transaksiAksi2"
                                                    id=<?= $data1['id_detail']; ?> title="hapus"></i></td>
                                            <?php
                            } ?>
                                        </tr>
                                        <?php
                  ...
                  if($jabatan!="Kasir"){?>
                            ...
                            <td align="center">
                                <a href="cetak_struk.php?no_transaksi=<?= $no_transaksi;?>"
